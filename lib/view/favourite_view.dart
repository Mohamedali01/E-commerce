        ...
        return Scaffold(
          appBar: AppBar(
            ...
            leading: GestureDetector(
                ...
                child: Image.asset('assets/images/Icon_Arrow-Left.png',width: 30,height: 30,)),
            title: Text('Favourites',style: TextStyle(color: Colors.black,fontSize: 24),),
          ),
                    ...
                    itemBuilder: (_, index) {
                      return Dismissible(
                        ...
                        onDismissed: (dismissDirection) {
                            controller.removeFavourite(controller
                                .favourites[index].cartId);
                        },
